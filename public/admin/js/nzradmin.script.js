...
/* 03. Dore Main Plugin */
$.nzradmin = function (element, options) {
  var defaults = {};
  var plugin = this;
  plugin.settings = {};
  var $element = $(element);
  ...
  function init() {
    ...
    if ($().DataTable) {
      ...
      $(".data-table-category-image").DataTable({
        sDom: '<"row view-filter"<"col-sm-12"<"float-right"l><"float-left"f><"clearfix">>>t<"row view-pager"<"col-sm-12"<"text-center"ip>>>',
        pageLength: 10,
        "columns": [
          { "data": "srno" },
      ...
      $(".data-table-category-imagess").DataTable({
        sDom: '<"row view-filter"<"col-sm-12"<"float-right"l><"float-left"f><"clearfix">>>t<"row view-pager"<"col-sm-12"<"text-center"ip>>>',
        pageLength: 10,
        "columns": [
          { "data": "srno" },
...
$(".data-table-events-list").DataTable({
      ...
      $(".data-table-prdpriceoffer").DataTable({
        sDom: '<"row view-filter"<"col-sm-12"<"float-right"l><"float-left"f><"clearfix">>>t<"row view-pager"<"col-sm-12"<"text-center"ip>>>',
        pageLength: 10,
        "columns": [
          { "data": "srno" },
      ...
      $(".data-table-shipping-gallry").DataTable({
        sDom: '<"row view-filter"<"col-sm-12"<"float-right"l><"float-left"f><"clearfix">>>t<"row view-pager"<"col-sm-12"<"text-center"ip>>>',
        pageLength: 10,
        "columns": [
          { "data": "srno" },
      ...
      $(".data-table-shop-gallry").DataTable({
        sDom: '<"row view-filter"<"col-sm-12"<"float-right"l><"float-left"f><"clearfix">>>t<"row view-pager"<"col-sm-12"<"text-center"ip>>>',
        pageLength: 10,
        "columns": [
          { "data": "srno" },
        ...
        language: {
          ...
          lengthMenu: "Items Per Page _MENU_"
            ...
            $(".data-table-shop-gallryss").DataTable({
        sDom: '<"row view-filter"<"col-sm-12"<"float-right"l><"float-left"f><"clearfix">>>t<"row view-pager"<"col-sm-12"<"text-center"ip>>>',
        pageLength: 10,
        "columns": [
          { "data": "srno" },
      ...
      $(".data-table-shop-gallrypopular").DataTable({
        sDom: '<"row view-filter"<"col-sm-12"<"float-right"l><"float-left"f><"clearfix">>>t<"row view-pager"<"col-sm-12"<"text-center"ip>>>',
        pageLength: 10,
        "columns": [
          { "data": "srno" },
...
$.fn.nzradmin= function (options) {
  return this.each(function () {
    if (undefined == $(this).data("nzradmin")) {
      var plugin = new $.nzradmin(this, options);
      $(this).data("nzradmin", plugin);
    }
  });
};
