                ...
                <div class="col-12 col-md-10 mx-auto my-auto">
                    <div class="card auth-card">
                        <div class="position-relative image-side ">
                            ...
                            <p class="white mb-0">
                                To reset password, use your registered email address.
                            </p>
                        </div>
                        <div class="form-side">
                            @if (session('status'))
                            ...
                            <form method="post" action="{{ url('tsfy-admin/forgot-passwords') }}">
                                @csrf
                                ...
                                <div class="d-flex justify-content-end align-items-center">
                                    <button class="btn btn-primary btn-lg btn-shadow" type="submit">Send Instructions</button>
                                </div>
                            </form>
                        </div>
                    </div>
